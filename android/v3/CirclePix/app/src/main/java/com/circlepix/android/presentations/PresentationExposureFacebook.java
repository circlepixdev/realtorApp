 ...
 */
public class PresentationExposureFacebook extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_facebook);
        ...
        player.setPrevAndNextPage(PresentationExposureCompanyWebsite.class, PresentationExposureYouTube.class);
        player.playAudio();
    }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationExposureFacebook.this, BackgroundMusicService.class));
    }
}
