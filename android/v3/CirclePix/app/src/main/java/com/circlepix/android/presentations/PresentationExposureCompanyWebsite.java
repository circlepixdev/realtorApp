 ...
 */
public class PresentationExposureCompanyWebsite extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_companywebsite);
        ...
        player.setPrevAndNextPage(PresentationExposurePersonalWebsite.class, PresentationExposureFacebook.class);
        player.playAudio();
    }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationExposureCompanyWebsite.this, BackgroundMusicService.class));
    }
}
