 ...
 */
public class PresentationMediaListingVideo extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_media_listingvideo);
        ...
        player.setPrevAndNextPage(PresentationMediaPropertySite.class, PresentationMediaQRCodes.class); //(PresentationMediaPropertySite.class, PresentationMediaMobilePlatform.class);
        player.playAudio();
    }
    ...
    public void onResume() {
        ...
        if (myApp.wasInBackground)
        {
            ...
            player.setPrevAndNextPage(PresentationMediaPropertySite.class, PresentationMediaQRCodes.class);
            player.playAudio();
        }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationMediaListingVideo.this, BackgroundMusicService.class));
    }
}
