 ...
 */
public class PresentationExposureSeo extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_seo);
        ...
        player.setPrevAndNextPage(PresentationExposurePinterest.class, PresentationLeadGenIntro.class);
        player.playAudio();
    }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationExposureSeo.this, BackgroundMusicService.class));
    }
}
