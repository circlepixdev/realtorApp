 ...
 */
public class PresentationLeadGenFacebook extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_leadgen_facebook);
        ...
        player.setPrevAndNextPage(PresentationLeadGen24hourinfo.class, PresentationLeadGenMobileTour.class);
        player.playAudio();
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationLeadGenFacebook.this, BackgroundMusicService.class));
    }
}
