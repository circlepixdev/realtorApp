 ...
 */
public class PresentationExposurePinterest extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_pinterest);
        ...
        player.setPrevAndNextPage(PresentationExposureLinkedIn.class, PresentationExposureSeo.class);
        player.playAudio();
    }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationExposurePinterest.this, BackgroundMusicService.class));
    }
}
