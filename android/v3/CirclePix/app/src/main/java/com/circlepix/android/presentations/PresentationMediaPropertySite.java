 ...
 */
public class PresentationMediaPropertySite extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_media_propertysite);
        ...
        player.setPrevAndNextPage(PresentationMediaPhotography.class, PresentationMediaListingVideo.class);
        player.playAudio();
    }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationMediaPropertySite.this, BackgroundMusicService.class));
    }
}
