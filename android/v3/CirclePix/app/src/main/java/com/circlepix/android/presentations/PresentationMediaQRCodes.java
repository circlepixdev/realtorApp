 ...
 */
public class PresentationMediaQRCodes extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_media_qrcodes);
        ...
        player.setPrevAndNextPage(PresentationMediaListingVideo.class, PresentationMedia24HourInfo.class);
        player.playAudio();
    }
    ...
    public void onResume() {
        ...
        if (myApp.wasInBackground)
        {
            ...
            player.setPrevAndNextPage(PresentationMediaListingVideo.class, PresentationMedia24HourInfo.class); //(PresentationMediaMobilePlatform.class, PresentationMedia24HourInfo.class);
            player.playAudio();
        }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationMediaQRCodes.this, BackgroundMusicService.class));
