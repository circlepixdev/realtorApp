 ...
 */
public class PresentationLeadGen24hourinfo extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_leadgen_24hourinfo);
        ...
        player.setPrevAndNextPage(PresentationLeadGenPropertySite.class, PresentationLeadGenFacebook.class);
        player.playAudio();
    }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationLeadGen24hourinfo.this, BackgroundMusicService.class));
    }
}
