 ...
 */
public class PresentationExposureCraigslist extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_craigslist);
        ...
        player.setPrevAndNextPage(PresentationExposureBlogger.class, PresentationExposureLinkedIn.class);
        player.playAudio();
    }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationExposureCraigslist.this, BackgroundMusicService.class));
    }
}
