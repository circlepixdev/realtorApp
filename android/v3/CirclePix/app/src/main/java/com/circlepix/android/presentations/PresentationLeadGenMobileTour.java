 ...
 */
public class PresentationLeadGenMobileTour extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_leadgen_mobiletour);
        ...
        player.setPrevAndNextPage(PresentationLeadGenFacebook.class, PresentationCommIntro.class);
        player.playAudio();
    }
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationLeadGenMobileTour.this, BackgroundMusicService.class));
    }
}
