 ...
 */
public class PresentationExposurePersonalWebsite extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_personalwebsite);
        ...
        player.setPrevAndNextPage(PresentationExposurePortals.class, PresentationExposureCompanyWebsite.class);
        player.playAudio();
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationExposurePersonalWebsite.this, BackgroundMusicService.class));
    }
}
