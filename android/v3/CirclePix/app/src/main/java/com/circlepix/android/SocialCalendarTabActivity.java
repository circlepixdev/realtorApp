 ...
 */
public class SocialCalendarTabActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_social_calendar_tab);
...
//            fragment.setArguments(args);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            for (int i = 0; i < 20; i++) {
                items.add("Social Calendar: " + tabPosition + " item #" + i);
            }

            View v =  inflater.inflate(R.layout.fragment_social_calendar_tab, container, false);
