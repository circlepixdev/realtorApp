 ...
 */
public class PresentationCommIntro extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_comm_intro);
        ...
        player.setPrevAndNextPage(PresentationLeadGenMobileTour.class, PresentationCommStats.class);
        player.playAudio();
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationCommIntro.this, BackgroundMusicService.class));
    }
}
