 ...
 */
public class PresentationExposureTwitter extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_twitter);
        ...
        player.setPrevAndNextPage(PresentationExposureYouTube.class, PresentationExposureBlogger.class);
        player.playAudio();
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationExposureTwitter.this, BackgroundMusicService.class));
    }
}
