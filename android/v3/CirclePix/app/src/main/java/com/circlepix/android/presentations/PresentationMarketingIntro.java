 ...
 */
public class PresentationMarketingIntro extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_marketingintro);
        ...
        player.setPrevAndNextPage(PresentationStarMarketing.class, PresentationMediaPhotography.class);
        player.playAudio();
    }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationMarketingIntro.this, BackgroundMusicService.class));
    }
}
