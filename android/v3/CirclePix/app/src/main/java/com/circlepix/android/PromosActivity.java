  ...
  //  private PrefManager prefManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   prefManager = new PrefManager(this);
        Log.v("is firstrun", String.valueOf(appState.isFirstTimeLaunch()));
    ...
    private void launchHomeScreen() {
        appState.setFirstTimeLaunch(false);
        Log.v("is firstrun launch", String.valueOf(appState.isFirstTimeLaunch()));
