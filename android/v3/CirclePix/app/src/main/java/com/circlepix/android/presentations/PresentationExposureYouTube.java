 ...
 */
public class PresentationExposureYouTube extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_exposure_youtube);
        ...
        player.setPrevAndNextPage(PresentationExposureFacebook.class, PresentationExposureTwitter.class);
        player.playAudio();
    ...
    public void stopPresentation() {
        ...
        stopService(new Intent(PresentationExposureYouTube.this, BackgroundMusicService.class));
    }
}
