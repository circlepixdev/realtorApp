 ...
 */
public class PresentationCommEMarketing extends PresentationBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.presentation_comm_emarketing);
        ...
        player.setPrevAndNextPage(PresentationCommStats.class, PresentationCommBatchTexting.class);
        player.playAudio();
    }
    ...
    public void onBackPressed(){
        ...
        stopService(new Intent(PresentationCommEMarketing.this, BackgroundMusicService.class));
    }
}
