//
//  SettingsNarrationViewController.swift
//  CirclePix
//
...
class SettingsNarrationViewController: UITableViewController, AVAudioPlayerDelegate {
    ...
    override func viewDidLoad() {
        ...
        uncheckAll()
        checkCellByName(appDel.getSettingAsString(kGlobalNarration) as String)
    ...
    override func tableView(tableView: UITableView?, didSelectRowAtIndexPath indexPath: NSIndexPath?) {
        ...
        if let ip = indexPath {
            ...
            // Save the selection
            appDel.setStringSetting(kGlobalNarration, value: nameForCell(cell!))
        }
    }
