//
//  SettingsBgMusicViewController.swift
//  CirclePix
//
...
class SettingsBgMusicViewController: UITableViewController, AVAudioPlayerDelegate {
...
//    @IBOutlet weak var bgUpliftingSuccessCell: UITableViewCell!
    ...
    override func tableView(tableView: UITableView?, didSelectRowAtIndexPath indexPath: NSIndexPath?) {
        ...
        if let ip = indexPath {
            ...
            // Save the selection
            appDel.setStringSetting(kGlobalBgMusic, value: nameForCell(cell!))
        }
    }
    ...
    func checkCellByName(name: String) {
        ...
        else if name == "Song 1" {  //modern_business
